...
import { CreateOfekArgs } from "./CreateOfekArgs";
import { UpdateOfekArgs } from "./UpdateOfekArgs";
...
export class OfekResolverBase {
  ...
  async createOfek(@graphql.Args() args: CreateOfekArgs): Promise<Ofek> {
  ...
  async updateOfek(@graphql.Args() args: UpdateOfekArgs): Promise<Ofek | null> {
    try {
